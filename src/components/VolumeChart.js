...
export default function VolumeChart(props) {
  ...
  const csvFields = [
    ...
    {key: 'mint', name: 'Mint MJLP'},
    {key: 'burn', name: 'Burn MJLP'},
  ...
  return <ChartWrapper title="Volume" loading={loading} csvFields={csvFields} data={data}>
    <ResponsiveContainer width="100%" height={chartHeight}>
      <ComposedChart data={data} syncId="syncA">
        ...
        <Bar isAnimationActive={false} type="monotone" dataKey="mint" stackId="a" name="Mint MJLP" fill={COLORS[1]} />
        <Bar isAnimationActive={false} type="monotone" dataKey="burn" stackId="a" name="Burn MJLP" fill={COLORS[2]} />
